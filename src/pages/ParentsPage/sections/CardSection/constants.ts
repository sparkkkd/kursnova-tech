...
export const CARDS_DATA: ICard[] = [
	{
		...
		backText: 'N родителей тоже благополучно забыли школьную программу',
		emoji: emoji_1,
		rotate: -3,
	...
	},
	{
		...
		backText:
			'24 родителя других детей тоже хотели бы бокал вина вместо решения уравнений',
		emoji: emoji_2,
		rotate: 5,
	...
	},
	{
		...
		backText: 'Ещё у N родителей уроки — причина напряжения в семье',
		emoji: emoji_3,
		rotate: -5,
		background: '#cdfe9c',
		color: '#2a4311',
	},
	{
		...
		backText: 'N родителей недовольны современным школьным образованием',
		emoji: emoji_4,
		rotate: 2,
		background: '#dcdcf2',
		color: '#14141a',
	},
	{
		...
		backText: 'Для ещё N родителей это тоже головная боль',
		emoji: emoji_5,
		rotate: -3,
		background: '#bbadff',
		color: '#0e0056',
	},
	{
		...
		backText: '∞ детей тоже предпочитают весёлые видяшки',
		emoji: emoji_6,
		rotate: 6,
		background: 'linear-gradient(227deg, #fdbcff 0%, #e38ee5 100%)',
		color: '#4b264d',
	},
	{
		...
		backText:
			'N родителей беспокоит, что их ребёнка записали в категорию тупых и ленивых',
		emoji: emoji_7,
		rotate: -5,
		background: 'linear-gradient(26deg, #25252b 0%, #4b4b55 100%)',
		color: '#fff',
	},
	{
		...
		backText: 'N родителей разделяют вашу боль',
		emoji: emoji_8,
		rotate: 7,
		background: '#cdfe9c',
		color: '#2a4311',
	},
	{
		...
		backText:
			'N родителей тоже хотят вырастить ребёнка любознательным и активным',
		emoji: emoji_9,
		rotate: -3,
		background: '#dcdcf2',
		color: '#14141a',
